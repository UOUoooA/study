            ...
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr,index) in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0"
                    ...
                    @click="changeAvtive(spuSaleAttrValue,spuSaleAttr.spuSaleAttrValueList)"
                >
...
<script>
  ...
  export default {
    ...
    methods:{
          changeAvtive(saleAttrValue,arr){
    arr.forEach((item)=>{
      item.isChecked=0
    })
     ...
     async addShopcar(){
           try {
             await this.$store.dispatch('getAddShopcar', {skuId: this.$route.params.skuid, skuNum: this.skuNum})
