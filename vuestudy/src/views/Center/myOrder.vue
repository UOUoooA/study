    ...
    <div class="order-content">
      ...
      <div class="orders">
        ...
        <table class="order-item" v-for="(order,index) in myOrder.records" :key="order.id">
          ...
          <tbody>
          <tr v-for="art in order.orderDetailList" :key="art.id">
            <td width="60%">
              <div class="typographic">
                <img :src="art.imgUrl" style="height: 100px;width: 100px">
                <a href="#" class="block-text">{{ art.skuName }}</a>
                <span>{{art.skuNum}}</span>
